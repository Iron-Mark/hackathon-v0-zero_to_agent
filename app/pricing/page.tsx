...
export const metadata: Metadata = {
  ...
  description: 'Flexible pricing for individuals and enterprises. Bring your own keys for a generous free tier.',
}
            ...
            {[
              {
                ...
                a: "It means you use your own OpenAI or SerpApi credentials. HireProof acts as the 'middleware'—we provide the UI and the agentic logic, but you pay the inference costs directly to the providers. This allows us to keep the basic version free forever."
              },
              {
              ...
              {
                q: "How does the 'Proof of Human' work?",
                a: "We use forensic analysis—like checking for GPT-specific linguistic entropy and domain registration history—to determine if a job post was generated by a bot farm (Dead Internet Theory) or a real human recruiter."
              }
            ].map((faq) => (
