...
const SEARCH_INDEX: SearchItem[] = [
  ...
  { id: 'proof', title: 'Cursor Hackathon Proof Pack', description: 'Judge path for what was built with Cursor/Codex, live surfaces, demo fixtures, BYOK boundaries, and proof links.', href: '/proof', category: 'Proof', icon: ShieldCheck, keywords: ['submission', 'demo', 'evidence', 'workflow', 'slack', 'cursor hackathon', 'codex', 'byok', 'judge'], priority: 12 },
  { id: 'portfolio', title: 'Portfolio Case Study', description: 'Shipped product story, build decisions, proof points, and Cursor hackathon framing.', href: '/portfolio', category: 'Proof', icon: FileText, keywords: ['portfolio', 'case study', 'mark siazon', 'cursor hackathon', 'proof'], priority: 8 },
  ...
  { id: 'docs-pilot', title: 'Pilot Program', description: 'Cursor hackathon pilot path for communities, schools, recruiters, and job boards.', href: '/docs/pilot', category: 'Product', icon: UsersRound, keywords: ['pilot', 'startup', 'cursor hackathon', 'community', 'byok'], priority: 8 },
