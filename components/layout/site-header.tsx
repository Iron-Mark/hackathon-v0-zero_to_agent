...
const resourceGroups: ResourceGroup[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { href: '/pilot', label: 'Pilot Intake', description: 'Request a small proof run', icon: UsersRound },
      { href: '/portfolio', label: 'Case Study', description: 'Shipped product proof', icon: FileText },
      { href: '/docs/pilot', label: 'Pilot Program', description: '90-day startup path', icon: UsersRound },
