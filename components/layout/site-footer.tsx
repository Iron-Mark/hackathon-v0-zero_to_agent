  ...
  product: [
    {
      label: "Audit Engine",
      href: "/audit",
      description: "Verify a suspicious job post",
    },
    {
      label: "Exploration",
      href: "/explore",
      description: "Discover recent audit patterns",
    },
    {
      label: "Self-hosting / Plans",
      href: "/pricing",
      description: "BYOK and hosting options",
    },
    {
  ...
  resources: [
    {
      label: "Documentation",
      href: "/docs",
      description: "Guides for using HireProof",
    },
    {
      label: "API Reference",
    ...
    },
    {
      ...
      description: "n8n, Make, LangChain, and webhooks",
    },
    {
  ...
  legal: [
    {
      ...
      description: "Our usage agreement",
    },
    {
    ...
    },
    {
      label: "Disclaimer",
      href: "/docs/legal",
      description: "AI accuracy and limitations",
    },
    {
      label: "Security Whitepaper",
      href: "/docs/security",
      description: "Data and API safeguards",
    },
    {
      label: "Rate Limiting",
      href: "/docs/rate-limiting",
      description: "Fair use policies",
    },
  ],
};
      ...
      <AnimatePresence>
        {isVisible && (
          <motion.div
            ...
            className="absolute bottom-full left-1/2 mb-2 w-max max-w-55 -translate-x-1/2 rounded-xl border border-border-soft bg-surface/95 backdrop-blur-md px-4 py-2 text-[10px] font-black text-foreground shadow-2xl pointer-events-none z-50 text-center uppercase tracking-widest ring-1 ring-white/10"
          >
            {content}
